import { z } from 'zod';
import { ModelProviderName, type Character, type ClientConfig, type PluginConfig, type PostProcessor } from './types.js';
...
export function getEnvVariable(variableName: string, required: boolean = false): string | undefined {
